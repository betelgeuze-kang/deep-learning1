...
- v08은 external benchmark readiness gate입니다. v08-b adapter schema와 v08-c evidence schema는 RULER/LongBench/codebase retrieval/real document QA 4개 family를 덮지만, 현재는 source/result evidence가 없어 `external_benchmark_ready=0`, `action=defer-external-comparison`으로 통과합니다.
...
- 현재 검증 checkpoint는 h6-t/u/v/w/x/y, h10-a/b/c/d/e/f/g/h, h7-b가 h7 goal closure에 포함되어 있고, v08-b/v08-c adapter/evidence/readiness와 h9-e가 h9 quick closure에 연결된 상태입니다. HIP parity는 optional extended check로 남아 있습니다.
