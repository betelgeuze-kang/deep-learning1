...
- 현재 브랜치 `codex/route-memory-local-energy-policy`는 h10-q remote teacher-source live-network import checkpoint, v08-w external benchmark source-import official-authority checkpoint, h11-b PC RouteLM artifact verification checkpoint까지 최신입니다.
...
- v08-w가 현재 external-benchmark source-import boundary입니다. v08-m부터 v08-v까지는 source-import contract, live verifier/review, authoritative review, public registry, live registry query, fetch/cache, live-registry network proof, real verification을 연결합니다. v08-w는 official-authority layer입니다. v08-v가 non-placeholder verification row를 통과시키더라도, 그 row가 official authority/trust-root evidence와 묶이지 않으면 `source_import_verified=0`으로 다시 막습니다. Supplied fixture authority row는 `source_import_official_authority_review_ready=1`까지 갈 수 있지만 action `external-benchmark-source-import-official-authority-fixture-only`로 publish를 막습니다.
...
- 최신 검증 스택은 현재 touched v08 script `bash -n`, v08 source-import live-registry-query/fetcher/network-proof/real-verification/official-authority focused test, final-review guard focused tests, 그리고 v08-w까지 포함한 full `bash experiments/test_v09_gpu_backend_closure.sh` quick closure입니다.
...
- Real external benchmark source/result/review evidence가 v08-f부터 v08-w까지 통과하고 source/result/execution/attestation/identity artifact와 final-review artifact가 모두 non-local이며 live source-import verifier evidence, independent live review, authoritative source-import review, public-registry/source-import authority evidence, non-fixture runner-owned live registry query proof, non-fixture live registry fetch/cache proof, non-fixture live registry network proof, non-placeholder official real-verification record, official authority/trust-root record까지 있어야 v0.8 external comparison을 publish할 수 있습니다.
...
- 현재 route-memory checkpoint는 h10-a/b/c/d/e/f/g/h/i/j/k/l/m/n/o/p/q, h7-b, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r/v08-s/v08-t/v08-u/v08-v/v08-w, h11-a/h11-b입니다. h10은 여전히 diagnostic/source-gated이고, v08-b부터 v08-w까지는 external benchmark evidence를 adapter/import/comparison에서 source-import contract, live verifier, independent live review, authoritative review, public-registry, live-registry-query, live-registry fetch/cache, live-registry network-proof, real-verification, official-authority mechanics까지 밀어 올리지만 placeholder 또는 fixture authority evidence에서는 `source_import_verified=0`을 유지합니다. h11-a는 PC RouteLM / NLG prototype readiness contract를 열며, h11-b는 prototype artifact/provenance hash chain을 검증하되 local fixture를 real prototype으로 올리지 않습니다.
...
- 현재 검증 checkpoint는 h6-t/u/v/w/x/y, h10-a/b/c/d/e/f/g/h/i/j/k/l/m/n/o/p/q, h7-b가 h7 goal closure에 포함되어 있고, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r/v08-s/v08-t/v08-u/v08-v/v08-w readiness가 h9 quick closure에 연결된 상태입니다. HIP parity는 optional extended check로 남아 있습니다.
