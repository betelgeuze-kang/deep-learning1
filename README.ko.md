...
- 현재 브랜치 `codex/route-memory-local-energy-policy`는 h10-q remote teacher-source live-network import checkpoint, v08-u external benchmark source-import live-registry network-proof checkpoint, h11-b PC RouteLM artifact verification checkpoint까지 최신입니다.
...
- v08-u가 현재 external-benchmark source-import boundary입니다. v08-m은 non-local lower-chain source/result/execution artifact를 source-import contract와 묶고, v08-n부터 v08-r까지 verifier/live-verifier/live-review/authoritative-review/public-registry mechanics를 추가합니다. v08-s는 live registry query mechanics, v08-t는 live-registry fetch/cache proof layer, v08-u는 live-registry network-proof layer입니다. Runner-owned replay는 proof metadata, tool hash, request/header/TLS/DNS/nonce hash, cache/body hash binding을 검증하지만 live proof로 인정되지 않습니다. supplied live-style proof row는 `source_import_live_registry_network_proof_ready=1`까지 올라갈 수 있지만, 여전히 `source_import_verified=0`, `real_external_benchmark_verified=0`이고 `external-benchmark-source-import-live-registry-network-proof-fixture-only`에서 멈춥니다.
...
- 최신 검증 스택은 현재 touched v08 script `bash -n`, v08 source-import live-registry-query/fetcher/network-proof focused test, final-review guard focused tests, 그리고 v08-u까지 포함한 `bash experiments/test_v09_gpu_backend_closure.sh`입니다.
...
- Real external benchmark source/result/review evidence가 v08-f부터 v08-u까지 통과하고 source/result/execution/attestation/identity artifact와 final-review artifact가 모두 non-local이며 live source-import verifier evidence, independent live review, authoritative source-import review, public-registry/source-import authority evidence, non-fixture runner-owned live registry query proof, non-fixture live registry fetch/cache proof, non-fixture live registry network proof까지 있어야 v0.8 external comparison을 publish할 수 있습니다.
...
- 현재 route-memory checkpoint는 h10-a/b/c/d/e/f/g/h/i/j/k/l/m/n/o/p/q, h7-b, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r/v08-s/v08-t/v08-u, h11-a/h11-b입니다. h10은 여전히 diagnostic/source-gated이고, v08-b부터 v08-u까지는 external benchmark evidence를 adapter/import/comparison에서 source-import contract, live verifier, independent live review, authoritative review, public-registry, live-registry-query, live-registry fetch/cache, live-registry network-proof mechanics까지 밀어 올리지만 `source_import_verified=0`을 유지합니다. h11-a는 PC RouteLM / NLG prototype readiness contract를 열며, h11-b는 prototype artifact/provenance hash chain을 검증하되 local fixture를 real prototype으로 올리지 않습니다.
...
- 현재 검증 checkpoint는 h6-t/u/v/w/x/y, h10-a/b/c/d/e/f/g/h/i/j/k/l/m/n/o/p/q, h7-b가 h7 goal closure에 포함되어 있고, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r/v08-s/v08-t/v08-u readiness가 h9 quick closure에 연결된 상태입니다. HIP parity는 optional extended check로 남아 있습니다.
