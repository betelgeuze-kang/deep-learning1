...
- Real external benchmark source/result/review evidence가 v08-f부터 v08-l까지 통과하고 source/result/execution/attestation/identity artifact와 final-review artifact가 모두 non-local이어야 v0.8 external comparison을 publish할 수 있습니다.
