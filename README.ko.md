...
- v08-m이 현재 external-benchmark source-import boundary입니다. v08-l final-review mechanics는 여전히 `source_import_verified=0`에서 publish를 막고, v08-m은 non-local lower-chain source/result/execution artifact를 live-network import row, import manifest/fetch-log/reviewer artifact, real/non-fixture declaration, independent source-import review와 묶는 별도 contract를 추가했습니다. Remote-style contract fixture는 `source_import_contract_ready=1`까지 올라가지만, real source-import verifier/fetch evidence chain이 붙기 전까지 `source_import_verified=0`, `real_external_benchmark_verified=0`, action `external-benchmark-source-import-real-verifier-missing`을 유지합니다.
...
- 최신 검증 스택은 `bash -n experiments/*.sh`, `git diff --check`, focused h10-k/h10-l/h10-m/h10-n/h10-o/h10-p/h10-q scorer/source/content/fetch-attestation/runtime-fetcher/live-network-import/distillation tests, focused v08 source-import/default/remote-contract tests 및 lower-chain remote-artifact, v08-l final-review/import/real-source-guard/remote-review-guard/remote-full-source-import-guard tests, focused h11-b verifier/import tests, h11 readiness/import tests, `bash experiments/test_v09_gpu_backend_closure.sh`입니다.
...
- Real external benchmark source/result/review evidence가 v08-f부터 v08-m까지 통과하고 source/result/execution/attestation/identity artifact와 final-review artifact가 모두 non-local이며 real source-import verification까지 있어야 v0.8 external comparison을 publish할 수 있습니다.
...
- 현재 검증 checkpoint는 h6-t/u/v/w/x/y, h10-a/b/c/d/e/f/g/h/i/j/k/l/m/n/o/p/q, h7-b가 h7 goal closure에 포함되어 있고, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m adapter/evidence/import/comparison/real-evidence/artifact-verifier/authenticity/execution/attestation/attestor-identity/final-review/source-import readiness와 v08 lower-chain remote-artifact path, v08-l/v08-m real-source/remote-review/remote-full source-import guard, h11-a prototype readiness/import, h11-b artifact verifier/import, h9-g measured-speed gate/import가 h9 quick closure에 연결된 상태입니다. HIP parity는 optional extended check로 남아 있습니다.
