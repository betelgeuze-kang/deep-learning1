...
- 현재 브랜치 `codex/route-memory-local-energy-policy`는 v14-a runner-owned query/result/evaluator runner, v13-n external benchmark official source acquisition gate, v13-m source seed live-fetch gate, v13-l source seed gate, v13-k runtime fetch provenance gate, v13-j real evidence rebind gate, v13-i real evidence live-network gate, v13-h real evidence intake gate, v13-g real evidence promotion gate, v13-f resource envelope checkpoint, v13-e public codebase RouteQA binding checkpoint, v13-d real NLG transcript binding checkpoint, v13-c evidence packet ABI checkpoint, v13-b RouteLM mmap reader checkpoint, v13-a real-run binder manifest checkpoint, h10-s source-verified learned chunk scorer evaluation checkpoint, v08-at external benchmark official result reconciliation checkpoint, h11-d PC RouteLM diagnostic NLG smoke checkpoint, h9-h diagnostic CPU/HIP/NVMe workload speed evidence gate, h7-c promotion review gate, v12 paper/release claim audit까지 최신입니다.
