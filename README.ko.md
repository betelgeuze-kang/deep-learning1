...
- 현재 브랜치 `codex/route-memory-local-energy-policy`는 h10-q remote teacher-source live-network import checkpoint, v08-r external benchmark source-import public-registry checkpoint, h11-b PC RouteLM artifact verification checkpoint까지 최신입니다.
...
- v08-r이 현재 external-benchmark source-import boundary입니다. v08-m은 non-local lower-chain source/result/execution artifact를 live-network import row, import manifest/fetch-log/reviewer artifact, real/non-fixture declaration, independent source-import review와 묶어 `source_import_contract_ready=1`까지 올립니다. v08-n은 verifier replay, v08-o는 live verifier evidence, v08-p는 independent live-review, v08-q는 authoritative source-import review를 분리합니다. v08-r은 public-registry/source-import authority evidence layer입니다. Supplied non-local hash-attested registry row는 source-import ID, verifier run ID, live-review ID, authority-review ID, authority hash, verifier hash, registry entry artifact, operator identity, provenance를 묶어 `source_import_public_registry_ready=1`까지 올라갈 수 있지만, runner-owned live registry query/fetch path가 붙기 전까지 `source_import_verified=0`, `real_external_benchmark_verified=0`, action `external-benchmark-source-import-live-registry-query-missing`을 유지합니다.
...
- 최신 검증 스택은 현재 touched v08 script `bash -n`, v08 source-import public-registry focused test, final-review guard focused tests, 그리고 v08-r까지 포함한 전체 `bash experiments/test_v09_gpu_backend_closure.sh`입니다.
...
- Real external benchmark source/result/review evidence가 v08-f부터 v08-r까지 통과하고 source/result/execution/attestation/identity artifact와 final-review artifact가 모두 non-local이며 live source-import verifier evidence, independent live review, authoritative source-import review, public-registry/source-import authority evidence, runner-owned live registry query까지 있어야 v0.8 external comparison을 publish할 수 있습니다.
...
- 현재 route-memory checkpoint는 h10-a/b/c/d/e/f/g/h/i/j/k/l/m/n/o/p/q, h7-b, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r, h11-a/h11-b입니다. h10은 여전히 diagnostic/source-gated이고, v08-b부터 v08-r까지는 external benchmark evidence를 adapter/import/comparison에서 source-import contract, live verifier, independent live review, authoritative review, public-registry mechanics까지 밀어 올리지만 `source_import_verified=0`을 유지합니다. h11-a는 PC RouteLM / NLG prototype readiness contract를 열며, h11-b는 prototype artifact/provenance hash chain을 검증하되 local fixture를 real prototype으로 올리지 않습니다.
...
- v08 external benchmark readiness는 promotion gate가 열릴 때까지 외부 benchmark comparison을 defer합니다. v08-b부터 v08-l까지는 adapter/evidence/import/comparison/artifact/authenticity/execution/attestation/identity/final-review mechanics를 덮고, v08-m은 `source_import_contract_ready=1`, v08-n은 `source_import_verifier_ready=1`, v08-o는 `source_import_live_verifier_ready=1`, v08-p는 `source_import_independent_live_review_ready=1`, v08-q는 `source_import_authoritative_review_ready=1`, v08-r은 `source_import_public_registry_ready=1`까지 올릴 수 있습니다. 그래도 `source_import_verified=0`이므로 publish claim은 계속 막힙니다. h9-e는 CPU-canonical quick boundary에서 candidate-weight/proposal-score parity scaffold가 유지되는지 확인하며, HIP parity는 환경 의존 optional extended check입니다.
...
- 현재 검증 checkpoint는 h6-t/u/v/w/x/y, h10-a/b/c/d/e/f/g/h/i/j/k/l/m/n/o/p/q, h7-b가 h7 goal closure에 포함되어 있고, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r readiness가 h9 quick closure에 연결된 상태입니다. HIP parity는 optional extended check로 남아 있습니다.
