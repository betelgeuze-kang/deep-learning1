...
- v61ha proves the source-file promotion mechanics close only that mechanical witness gap; v61hb proves the checkpoint-root env mechanics close only one mechanical env gap; v61hc publishes a precheck-only lint runner; v61hd publishes a one-file external return form; v61he publishes the filled-form materializer; v61hf publishes the filled-form-to-guarded-runner handoff, and the live ubuntu-1 checklist is still 21 open items with the human/generation evidence blockers intact
