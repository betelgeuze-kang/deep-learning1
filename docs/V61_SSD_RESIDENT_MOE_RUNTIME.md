...
- v61gv audits that external workspace as a live checklist and currently identifies the remaining first-real-slice gap as seven witness files plus 16 env values
...
- v61ha proves the source-file promotion mechanics close only that mechanical witness gap and leave the human/generation evidence blockers intact
