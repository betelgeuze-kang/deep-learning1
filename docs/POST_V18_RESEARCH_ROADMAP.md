...
- Current verified state after PR run `27029089994` plus v33/v34/v35/v36/v37/v38/v39/v40/v41/v42/v43/v44/v45/v46: `independent_rerun_actual_ready=1`, `candidate_external_benchmark_result_ready=1`, `candidate_external_benchmark_expansion_ready=1`, `closed_corpus_poc_actual_ready=1`, `real_external_benchmark_verified=1`, `v33_evidence_closure_packet_ready=1`, `v34_official_benchmark_expansion_packet_ready=1`, `v35_commercial_pilot_packet_ready=1`, `v36_release_claim_audit_packet_ready=1`, `v37_human_review_intake_ready=1`, `v38_human_review_dispatch_bundle_ready=1`, `v39_human_review_dispatch_archive_ready=1`, `v40_machine_verified_research_artifact_ready=1`, `v41_ruler_niah_50row_scale_ready=1`, `v42_codebase_auditor_200query_ready=1`, `v43_doc_code_conflict_detection_ready=1`, `v44_tiny_non_attention_generator_hint_ready=1`, `v45_longbench_v2_small_slice_ready=1`, and `v46_source_verified_scorer_mainline_ready=1`; `maximum_allowed_claim_decided=1`, `human_review_request_ready=1`, `return_template_ready=1`, `verify_script_ready=1`, `archive_sha256_ready=1`, `archive_file_list_ready=1`, `machine_verification_ready=1`, `automated_research_artifact_ready=1`, `machine_verified_prototype_ready=1`, `row_count_ready=1`, `same_context_length=1`, `no_oracle_no_extractor_ready=1`, `v18_verified=1`, `query_rows=200`, `poc_result_rows=200`, `audit_trail_rows=200`, `conflict_rows=8`, `consistent_rows=4`, `supporting_source_spans_ready=1`, `no_raw_prompt_stuffing_ready=1`, `non_attention_generator_ready=1`, `answer_grounded_rate=1.000000`, `task_categories=6`, `v18_candidate_external_benchmark_result_ready=1`, `source_verified_label_rows=12`, `scorer_top1_accuracy=1.000000`, `wrong_candidate_guard_ready=1`, `privacy_review_ready=1`, `resource_envelope_ready=1`, and `v18_closed_corpus_poc_actual_ready=1`, but `human_review_return_supplied=0`, `human_review_completed=0`, `human_review_required_for_public_release=1`, and `real_release_package_ready=0` remain blocked until external review accepts the evidence set.
...
- Next: do not add another internal packaging layer. Follow the v47 impact
  roadmap below from `v47`, with human review deferred until release-ready
