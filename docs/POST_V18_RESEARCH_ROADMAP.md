...
- The v41-v47 impact roadmap is closed, and v48 starts the post-v47 evidence-scale/use-surface phase. Do not add another internal packaging layer unless a real return exposes a verifier gap, with human review deferred until release-ready wording becomes necessary.
