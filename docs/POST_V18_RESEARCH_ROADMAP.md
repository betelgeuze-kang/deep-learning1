...
- Current verified state after PR run `27029089994` plus v33/v34/v35/v36/v37: `independent_rerun_actual_ready=1`, `candidate_external_benchmark_result_ready=1`, `candidate_external_benchmark_expansion_ready=1`, `closed_corpus_poc_actual_ready=1`, `real_external_benchmark_verified=1`, `v33_evidence_closure_packet_ready=1`, `v34_official_benchmark_expansion_packet_ready=1`, `v35_commercial_pilot_packet_ready=1`, `v36_release_claim_audit_packet_ready=1`, and `v37_human_review_intake_ready=1`; `maximum_allowed_claim_decided=1` and `human_review_request_ready=1`, but `human_review_return_supplied=0`, `human_review_completed=0`, and `real_release_package_ready=0` remain blocked until external review accepts the evidence set.
...
- Next: complete one independent human-review pass over the v33/v34/v35/v36 evidence set and return `human_review_rows.csv` through v37. The reviewer should either accept GitHub-hosted runner evidence for this stage or request a non-GitHub independent rerun before any release package can be marked ready.
