...
- Current verified state after PR run `27029089994` plus v33/v34/v35/v36/v37/v38/v39: `independent_rerun_actual_ready=1`, `candidate_external_benchmark_result_ready=1`, `candidate_external_benchmark_expansion_ready=1`, `closed_corpus_poc_actual_ready=1`, `real_external_benchmark_verified=1`, `v33_evidence_closure_packet_ready=1`, `v34_official_benchmark_expansion_packet_ready=1`, `v35_commercial_pilot_packet_ready=1`, `v36_release_claim_audit_packet_ready=1`, `v37_human_review_intake_ready=1`, `v38_human_review_dispatch_bundle_ready=1`, and `v39_human_review_dispatch_archive_ready=1`; `maximum_allowed_claim_decided=1`, `human_review_request_ready=1`, `return_template_ready=1`, `verify_script_ready=1`, `archive_sha256_ready=1`, and `archive_file_list_ready=1`, but `human_review_return_supplied=0`, `human_review_completed=0`, and `real_release_package_ready=0` remain blocked until external review accepts the evidence set.
