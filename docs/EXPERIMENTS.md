...
- The h10 PM real-label promotion readiness gate binds h10-s to the current
  ...
  v53aq 4000-trace/4000-evaluator real-adapter evidence plus the four-row
  v53t real-adapter freeze packet, but keeps
