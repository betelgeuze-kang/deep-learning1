...
8. Closed as v53g/v53h/v53i/v53j/v53k/v53l/v53m seeds: expand v53c canary snapshots into a recursive complete-source tree manifest, complete-source content snapshot, 1000-row complete-source query/source-span instantiation, complete-source A/B/C/D/E/G/H intake surface, and System A/B/C local measured rows for the 10 locked repositories.
9. Supply valid D/E/G/H answer/citation/resource rows over v53j, then add symmetric scorer/policy rows over that frozen query set.
