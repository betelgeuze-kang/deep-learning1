...
The v54c complete-source grounded generation layer replays the v54 1000-row generation target over the frozen v53i complete-source query/source-span benchmark and the v53ap A/B/G/H deterministic source-span adapter surface. It emits `answer_rows.csv`, `citation_rows.csv`, `unsupported_claim_rows.csv`, `abstain_rows.csv`, `generator_resource_rows.csv`, `wrong_answer_guard_rows.csv`, compact RouteHint and generator-input rows, a sha256 manifest, and `sha256sums.txt`. It now records generated answers as source-span-derived fixture output rather than raw expected-answer replay, binds every generated row to v53ap H-adapter-trace provenance, and marks `v54_generation_1000_ready=1`, `generated_from_source_span_rows=1000`, `v53ap_adapter_trace_provenance_ready=1`, `v53ap_adapter_trace_provenance_rows=1000`, `attention_blocks=0`, `transformer_blocks=0`, `raw_prompt_context_appended_rows=0`, `model_visible_leakage_guard_ready=1`, `model_visible_input_fields=sanitized_question,opaque_routehint`, `model_visible_forbidden_field_used_rows=0`, `model_visible_source_locator_rows=0`, `deterministic_source_span_generation_fixture_ready=1`, `real_model_generation_ready=0`, `wrong_answer_rows=0`, and `missing_specific_abstain_rows=30`, while keeping real model generation quality, human-reviewed generation quality, public 30B-150B comparison wording, release readiness, and production claims blocked.
