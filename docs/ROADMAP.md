...
As of h10-i plus v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j, h11-a, and the h7/h9 quick closures, the project should be read as:
...
- Provide or connect real external benchmark sources/results through the
  v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j
  import/comparison/real-evidence/artifact-verifier/authenticity/execution/attestation
  path, then pass the v08-j independent external attestation gate before any
  v0.8 comparison claim.
