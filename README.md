...
- Branch `codex/route-memory-local-energy-policy` is current through the h10-q remote teacher-source live-network import checkpoint, v08-v external benchmark source-import real-verification checkpoint, and the h11-b PC RouteLM artifact verification checkpoint.
...
- v08-v is now the current external-benchmark source-import boundary. v08-m through v08-u carry the chain from source-import contract, live verifier/review, authoritative review, public registry, live registry query, fetch/cache, and live-registry network proof. v08-v adds a real source-import verification layer: supplied verification rows can bind network-proof rows to verification reports, verifier identities, proof transcripts, and cache hashes, but placeholder domains such as `example.invalid` still keep `source_import_verified=0` and `real_external_benchmark_verified=0` with `external-benchmark-source-import-real-verification-placeholder-domain`.
...
- Latest verified command stack: `bash -n` for the touched v08 scripts, focused v08 source-import live-registry-query/fetcher/network-proof/real-verification and final-review guard tests, plus full `bash experiments/test_v09_gpu_backend_closure.sh` quick closure through v08-v.
...
- Real external benchmark source/result/review evidence must pass the v08-f through v08-v chain with non-local source/result/execution/attestation/identity artifacts, non-local final-review artifacts, live source-import verifier evidence, independent live review, authoritative source-import review, public-registry/source-import authority evidence, non-fixture runner-owned live registry query proof, non-fixture live registry fetch/cache proof, non-fixture live registry network proof, and non-placeholder official real-verification records before any v0.8 external comparison can be published.
...
- Treat h10-a through h10-q, h7-b, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r/v08-s/v08-t/v08-u/v08-v, and h11-a/h11-b as the current route-memory policy checkpoint. h10 remains diagnostic/source-gated. v08-b through v08-v now carry external benchmark evidence from adapter/import/comparison through source-import contract, live verifier, independent live review, authoritative review, public-registry, live-registry-query, live-registry fetch/cache, live-registry network-proof, and real-verification mechanics while still keeping `source_import_verified=0` for placeholder fixtures; h11-a defines the PC RouteLM / NLG prototype readiness contract, and h11-b verifies prototype artifact/provenance hash chains while keeping local fixtures non-real.
...
- Current verification checkpoint: h6-t/u/v/w/x/y, h10-a/b/c/d/e/f/g/h/i/j/k/l/m/n/o/p/q, and h7-b are wired into the h7 goal closure, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r/v08-s/v08-t/v08-u/v08-v readiness is wired into h9 quick closure, and HIP parity remains optional/environment-dependent.
