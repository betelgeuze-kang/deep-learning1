...
- Branch `codex/route-memory-local-energy-policy` is current through the h10-q remote teacher-source live-network import checkpoint, v08-w external benchmark source-import official-authority checkpoint, and the h11-b PC RouteLM artifact verification checkpoint.
...
- v08-w is now the current external-benchmark source-import boundary. v08-m through v08-v carry the chain from source-import contract, live verifier/review, authoritative review, public registry, live registry query, fetch/cache, live-registry network proof, and real verification. v08-w adds an official-authority layer: even if v08-v can pass non-placeholder verification rows, source import is still forced back to `source_import_verified=0` unless those rows are bound to official authority/trust-root evidence; supplied fixture authority rows reach `source_import_official_authority_review_ready=1` but remain blocked with `external-benchmark-source-import-official-authority-fixture-only`.
...
- Latest verified command stack: `bash -n` for the touched v08 scripts, focused v08 source-import live-registry-query/fetcher/network-proof/real-verification/official-authority and final-review guard tests, plus full `bash experiments/test_v09_gpu_backend_closure.sh` quick closure through v08-w.
...
- Treat h10-a through h10-q, h7-b, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r/v08-s/v08-t/v08-u/v08-v/v08-w, and h11-a/h11-b as the current route-memory policy checkpoint. h10 remains diagnostic/source-gated. v08-b through v08-w now carry external benchmark evidence from adapter/import/comparison through source-import contract, live verifier, independent live review, authoritative review, public-registry, live-registry-query, live-registry fetch/cache, live-registry network-proof, real-verification, and official-authority mechanics while still keeping `source_import_verified=0` for placeholder or fixture authority evidence; h11-a defines the PC RouteLM / NLG prototype readiness contract, and h11-b verifies prototype artifact/provenance hash chains while keeping local fixtures non-real.
...
- v08 adds an external benchmark readiness gate. v08-b through v08-l cover adapter/evidence/import/comparison/artifact/authenticity/execution/attestation/identity/final-review mechanics. v08-m can raise `source_import_contract_ready=1`, v08-n can raise `source_import_verifier_ready=1`, v08-o can raise `source_import_live_verifier_ready=1`, v08-p can raise `source_import_independent_live_review_ready=1`, v08-q can raise `source_import_authoritative_review_ready=1`, v08-r can raise `source_import_public_registry_ready=1`, v08-s can raise `source_import_live_registry_query_ready=1`, v08-t can raise `source_import_live_registry_fetch_ready=1`, v08-u can raise `source_import_live_registry_network_proof_ready=1`, v08-v can raise `source_import_real_verification_review_ready=1`, and v08-w can raise `source_import_official_authority_review_ready=1` while still leaving `source_import_verified=0` for fixture authority records. Source/result/baseline/license evidence is still absent in the default run, so readiness still defers external comparison (`external_benchmark_ready=0`, `action=defer-external-comparison`) until promotion and real evidence exist.
...
- Current verification checkpoint: h6-t/u/v/w/x/y, h10-a/b/c/d/e/f/g/h/i/j/k/l/m/n/o/p/q, and h7-b are wired into the h7 goal closure, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r/v08-s/v08-t/v08-u/v08-v/v08-w readiness is wired into h9 quick closure, and HIP parity remains optional/environment-dependent.
