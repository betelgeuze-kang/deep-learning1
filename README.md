...
The v61r, v61w, v61ae, and v61af target-override smokes verify that `V61R_WAREHOUSE_ROOT`, `V61W_WAREHOUSE_ROOT`, `V61AE_WAREHOUSE_ROOT`, and `V61AF_WAREHOUSE_ROOT` force fresh source planning and preserve the external NVMe warehouse target through page-hash planning, materialization resume planning, generation admission evidence, and guarded operator scripts.
