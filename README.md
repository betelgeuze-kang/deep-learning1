...
- Branch `codex/route-memory-local-energy-policy` is current through the h10-q remote teacher-source live-network import checkpoint, v08-r external benchmark source-import public-registry checkpoint, and the h11-b PC RouteLM artifact verification checkpoint.
...
- v08-r is now the current external-benchmark source-import boundary. v08-m binds non-local lower-chain source/result/execution artifacts to live-network import rows, import manifest/fetch-log/reviewer artifacts, real/non-fixture declarations, and independent source-import review, reaching `source_import_contract_ready=1`. v08-n adds runner-owned verifier/fetch-evidence replay rows, v08-o separates replay from live verifier evidence, v08-p adds independent live review, and v08-q adds authoritative source-import review. v08-r adds the public-registry/source-import authority evidence layer: supplied non-local, hash-attested registry rows can bind source-import IDs, verifier run IDs, live-review IDs, authority-review IDs, authority hashes, verifier hashes, registry entry artifacts, operator identity, and provenance, reaching `source_import_public_registry_ready=1`, but still keeps `source_import_verified=0` and `real_external_benchmark_verified=0` with `external-benchmark-source-import-live-registry-query-missing` until a runner-owned live registry query/fetch path replaces supplied registry fixtures.
...
- Latest verified command stack: `bash -n` for the touched v08 scripts, focused v08 source-import public-registry and final-review guard tests, plus full `bash experiments/test_v09_gpu_backend_closure.sh` with v08-r included.
...
- Real external benchmark source/result/review evidence must pass the v08-f through v08-r chain with non-local source/result/execution/attestation/identity artifacts, non-local final-review artifacts, live source-import verifier evidence, independent live review, authoritative source-import review, public-registry/source-import authority evidence, and then a runner-owned live registry query before any v0.8 external comparison can be published.
...
- Treat h10-a through h10-q, h7-b, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r, and h11-a/h11-b as the current route-memory policy checkpoint. h10 remains diagnostic/source-gated. v08-b through v08-r now carry external benchmark evidence from adapter/import/comparison through source-import contract, live verifier, independent live review, authoritative review, and public-registry mechanics while still keeping `source_import_verified=0`; h11-a defines the PC RouteLM / NLG prototype readiness contract, and h11-b verifies prototype artifact/provenance hash chains while keeping local fixtures non-real.
...
- Current verification checkpoint: h6-t/u/v/w/x/y, h10-a/b/c/d/e/f/g/h/i/j/k/l/m/n/o/p/q, and h7-b are wired into the h7 goal closure, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r readiness is wired into h9 quick closure, and HIP parity remains optional/environment-dependent.
