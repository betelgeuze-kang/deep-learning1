...
- Branch `codex/route-memory-local-energy-policy` is current through the h10-q remote teacher-source live-network import checkpoint, v08-o external benchmark live source-import verifier checkpoint, and the h11-b PC RouteLM artifact verification checkpoint.
...
- Real external benchmark source/result/review evidence must pass the v08-f through v08-o chain with non-local source/result/execution/attestation/identity artifacts, non-local final-review artifacts, live source-import verifier evidence, and independent live review before any v0.8 external comparison can be published.
...
- Current verification checkpoint: h6-t/u/v/w/x/y, h10-a/b/c/d/e/f/g/h/i/j/k/l/m/n/o/p/q, and h7-b are wired into the h7 goal closure, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o adapter/evidence/import/comparison/real-evidence/artifact-verifier/authenticity/execution/attestation/attestor-identity/final-review/source-import/source-import-verifier/live-verifier readiness plus the v08 lower-chain remote-artifact path and v08-l/v08-m/v08-n/v08-o real-source/remote-review/remote-full source-import guards, h11-a readiness/import, h11-b artifact verifier/import, and h9-g measured-speed gate/import are wired into h9 quick closure, and HIP parity remains optional/environment-dependent.
