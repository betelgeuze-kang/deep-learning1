...
- The v41-v47 impact roadmap is closed. Next work should only open if a real external return, human review, or release-readiness requirement exposes a concrete verifier gap. Keep the claim local evidence-bound QA/audit assistance, not Transformer replacement, frontier local LLM, GPU acceleration, long-context solved, or expert replacement.
