...
- Branch `codex/route-memory-local-energy-policy` is current through the h10-q remote teacher-source live-network import checkpoint, v08-u external benchmark source-import live-registry network-proof checkpoint, and the h11-b PC RouteLM artifact verification checkpoint.
...
- v08-u is now the current external-benchmark source-import boundary. v08-m binds non-local lower-chain source/result/execution artifacts to live-network import rows and independent source-import review; v08-n through v08-r add verifier, live-verifier, live-review, authoritative-review, and public-registry mechanics; v08-s adds live registry query mechanics; and v08-t adds live-registry fetch/cache proof. v08-u adds the live-registry network-proof layer: runner-owned replay can verify proof metadata, tool hash, request/header/TLS/DNS/nonce hashes, and cache/body hash binding but remains non-live; supplied live-style proof rows can reach `source_import_live_registry_network_proof_ready=1`, while `source_import_verified=0` and `real_external_benchmark_verified=0` remain blocked as `external-benchmark-source-import-live-registry-network-proof-fixture-only`.
...
- Latest verified command stack: `bash -n` for the touched v08 scripts, focused v08 source-import live-registry-query/fetcher/network-proof and final-review guard tests, plus h9 closure with v08-u included.
...
- Real external benchmark source/result/review evidence must pass the v08-f through v08-u chain with non-local source/result/execution/attestation/identity artifacts, non-local final-review artifacts, live source-import verifier evidence, independent live review, authoritative source-import review, public-registry/source-import authority evidence, non-fixture runner-owned live registry query proof, non-fixture live registry fetch/cache proof, and non-fixture live registry network proof before any v0.8 external comparison can be published.
...
- Treat h10-a through h10-q, h7-b, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r/v08-s/v08-t/v08-u, and h11-a/h11-b as the current route-memory policy checkpoint. h10 remains diagnostic/source-gated. v08-b through v08-u now carry external benchmark evidence from adapter/import/comparison through source-import contract, live verifier, independent live review, authoritative review, public-registry, live-registry-query, live-registry fetch/cache, and live-registry network-proof mechanics while still keeping `source_import_verified=0`; h11-a defines the PC RouteLM / NLG prototype readiness contract, and h11-b verifies prototype artifact/provenance hash chains while keeping local fixtures non-real.
...
- v08 adds an external benchmark readiness gate. v08-b through v08-l cover adapter/evidence/import/comparison/artifact/authenticity/execution/attestation/identity/final-review mechanics. v08-m can raise `source_import_contract_ready=1`, v08-n can raise `source_import_verifier_ready=1`, v08-o can raise `source_import_live_verifier_ready=1`, v08-p can raise `source_import_independent_live_review_ready=1`, v08-q can raise `source_import_authoritative_review_ready=1`, v08-r can raise `source_import_public_registry_ready=1`, v08-s can raise `source_import_live_registry_query_ready=1`, v08-t can raise `source_import_live_registry_fetch_ready=1`, and v08-u can raise `source_import_live_registry_network_proof_ready=1` while still leaving `source_import_verified=0`. Source/result/baseline/license evidence is still absent in the default run, so readiness still defers external comparison (`external_benchmark_ready=0`, `action=defer-external-comparison`) until promotion and real evidence exist.
...
- Current verification checkpoint: h6-t/u/v/w/x/y, h10-a/b/c/d/e/f/g/h/i/j/k/l/m/n/o/p/q, and h7-b are wired into the h7 goal closure, v08-b/v08-c/v08-d/v08-e/v08-f/v08-g/v08-h/v08-i/v08-j/v08-k/v08-l/v08-m/v08-n/v08-o/v08-p/v08-q/v08-r/v08-s/v08-t/v08-u readiness is wired into h9 quick closure, and HIP parity remains optional/environment-dependent.
