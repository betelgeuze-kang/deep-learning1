...
if [ -f scripts/test_amr_beta_env_path_guards.py ]; then
  python3 scripts/test_amr_beta_env_path_guards.py >/dev/null
fi
...
if [ -f scripts/test_amr_beta_human_input_status.py ]; then
  python3 scripts/test_amr_beta_human_input_status.py >/dev/null
fi
if [ -f scripts/test_amr_beta_maintainer_feedback_packet.py ]; then
  python3 scripts/test_amr_beta_maintainer_feedback_packet.py >/dev/null
fi
...
if [ -f scripts/test_amr_beta_operator_status.py ]; then
  python3 scripts/test_amr_beta_operator_status.py >/dev/null
fi
if [ -f scripts/test_amr_beta_readiness_backlog.py ]; then
  python3 scripts/test_amr_beta_readiness_backlog.py >/dev/null
fi
if [ -f scripts/test_amr_beta_design_partner_packet.py ]; then
  python3 scripts/test_amr_beta_design_partner_packet.py >/dev/null
fi
if [ -f scripts/test_amr_beta_hardening_analyze.py ]; then
  python3 scripts/test_amr_beta_hardening_analyze.py >/dev/null
fi
