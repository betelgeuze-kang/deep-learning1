...
# blind-eval intake, SSD/checkpoint runtime slices, and known scale/stress tests
# that routinely exceed the lightweight CI shard budget or require prepared
