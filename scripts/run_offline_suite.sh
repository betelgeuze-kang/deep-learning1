...
# blind-eval intake, and known scale/stress/checkpoint-hotset tests that
# routinely exceed the lightweight CI shard budget or require prepared artifacts.
# Those tests remain runnable directly and in the self-hosted/evidence lanes.
#
# Usage:
