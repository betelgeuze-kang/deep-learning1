...
pm_pr_core_files = [
    ...
    (pr_run_dir / "source_v53t/complete_source_v1_exit_criteria_rows.csv", "source_pm_pr_claim_slice_gate/source_v53t/complete_source_v1_exit_criteria_rows.csv", "evidence"),
