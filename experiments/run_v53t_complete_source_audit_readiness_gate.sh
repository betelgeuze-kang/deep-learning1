...
v1_exit_criteria_rows = [
    ...
    v1_exit_criterion_row(
        ...
        "A/B/G/H deterministic rows and query-text-only real-adapter ledger share the same query hash",
