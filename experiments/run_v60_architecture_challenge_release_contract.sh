...
V59E_H10_ACCEPTANCE_EVIDENCE_ARTIFACT="$V59E_DIR/source_pm_pr_claim_slice_gate/source_h10_pm/h10_real_label_acceptance_evidence_rows.csv"
...
h10_pm_acceptance_evidence_rows = read_rows(run_dir / "source_h10_pm" / "h10_real_label_acceptance_evidence_rows.csv")
h10_pm_acceptance_evidence_by_criterion = {row.get("criterion", ""): row for row in h10_pm_acceptance_evidence_rows}
h10_pm_acceptance_evidence_ready = int(
    len(h10_pm_acceptance_evidence_rows) == len(expected_h10_pm_criteria)
    and set(h10_pm_acceptance_evidence_by_criterion) == expected_h10_pm_criteria
    and all(row.get("claim_boundary_status") == "pass" for row in h10_pm_acceptance_evidence_rows)
    and all(row.get("output_artifact_replay_status") == "pass" for row in h10_pm_acceptance_evidence_rows)
    and all(row.get("blocker_false_positive_status") == "pass" for row in h10_pm_acceptance_evidence_rows)
    and all(row.get("acceptance_ready") == "1" for row in h10_pm_acceptance_evidence_rows)
    and all(row.get("promotion_ready") == "0" for row in h10_pm_acceptance_evidence_rows)
...
h10_pm_source_provenance_binding_ready = int(
    ...
    and "v53aq_same_query_internal_prebaseline_rows=1000" in h10_source_row.get("evidence", "")
    and "v53aq_same_query_internal_prebaseline_rows_ready=1" in h10_source_row.get("evidence", "")
    and "v53t_real_adapter_freeze_rows=4" in h10_source_row.get("evidence", "")
    and as_int(h10, "source_provenance_binding_ready") == 1
    and as_int(h10, "v53aq_same_query_internal_prebaseline_rows_ready") == 1
...
requirements = [
    ...
    req(
        ...
        and h10_pm_acceptance_evidence_ready == 1
...
summary = {
    ...
    "public_source_snapshot_replay_rows": as_int(v59e, "public_source_snapshot_replay_rows"),
    "public_source_snapshot_replay_pass_rows": as_int(v59e, "public_source_snapshot_replay_pass_rows"),
    "public_source_snapshot_replay_ready": as_int(v59e, "public_source_snapshot_replay_ready"),
    ...
    "h10_pm_acceptance_evidence_rows": len(h10_pm_acceptance_evidence_rows),
...
manifest = {
    ...
    "v58_acceptance_evidence_tests_only_rows": as_int(v59e, "v58_acceptance_evidence_tests_only_rows"),
    "v58_acceptance_evidence_hidden_state_rows": as_int(v59e, "v58_acceptance_evidence_hidden_state_rows"),
    "pm_pr_v56_replay_acceptance_evidence_rows": as_int(v59e, "pm_pr_v56_replay_acceptance_evidence_rows"),
    "pm_pr_v56_replay_acceptance_evidence_ready_rows": as_int(v59e, "pm_pr_v56_replay_acceptance_evidence_ready_rows"),
    "pm_pr_v56_replay_acceptance_evidence_blocked_rows": as_int(v59e, "pm_pr_v56_replay_acceptance_evidence_blocked_rows"),
    "pm_pr_v56_replay_acceptance_evidence_tests_only_rows": as_int(v59e, "pm_pr_v56_replay_acceptance_evidence_tests_only_rows"),
    "pm_pr_v56_replay_acceptance_evidence_fixture_allowed_rows": as_int(v59e, "pm_pr_v56_replay_acceptance_evidence_fixture_allowed_rows"),
    "pm_pr_v56_replay_acceptance_evidence_approval_rows": as_int(v59e, "pm_pr_v56_replay_acceptance_evidence_approval_rows"),
    ...
    "h10_pm_acceptance_evidence_sha256": sha_or_empty(run_dir / "source_h10_pm" / "h10_real_label_acceptance_evidence_rows.csv"),
    "v53_query_span_binding_audit_ready": as_int(v53t, "foundation_query_span_binding_audit_ready"),
    "v53_query_span_binding_audit_rows": as_int(v53t, "foundation_query_span_binding_audit_rows"),
    "v53_query_span_binding_pass_rows": as_int(v53t, "foundation_query_span_binding_pass_rows"),
    "pm_pr_v53_query_span_binding_audit_ready": as_int(v59e, "pm_pr_v53_query_span_binding_audit_ready"),
