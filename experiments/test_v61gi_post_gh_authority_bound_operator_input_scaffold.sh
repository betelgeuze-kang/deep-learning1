...
if len(template_rows) != 12:
    raise SystemExit("v61gi expected 12 template rows")
...
for gate in ["source-v61gh-ready", "operator-input-scaffold", "templates-count-as-evidence", "zero-repo-checkpoint-payload"]:
