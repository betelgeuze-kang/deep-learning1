...
CYCLES_PER_EPOCH=10
PROPOSAL_COUNT=22
PREFIX="v05_route_quality_candidate_ultra_beta"
KEY_COUNTS=(128 256)
SEEDS=(1 2 3)
NOISY_RATES=(0.25 0.50)
ARMS=(
  "candidate-b8p00-cap8p0:8.00:8.0"
  "candidate-b10p00-cap10p0:10.00:10.0"
  "candidate-b10p00-cap12p0:10.00:12.0"
  "candidate-b12p00-cap12p0:12.00:12.0"
  "candidate-b12p00-cap16p0:12.00:16.0"
)
...
if [[ "$MODE" == "smoke" ]]; then
  ...
  CYCLES_PER_EPOCH=6
  PROPOSAL_COUNT=18
  PREFIX="v05_route_quality_candidate_ultra_beta_smoke"
  KEY_COUNTS=(128)
  SEEDS=(1)
  NOISY_RATES=(0.25)
  ARMS=(
...
run_case() {
  ...
  echo "quality-candidate-ultra-beta: ${scenario} beta=${candidate_beta} cap=${candidate_max}" >&2
  "$BUILD_DIR/dmv02" \
    --input "$fixture" \
    --N "$n" \
    --epochs "$EPOCHS" \
