...
artifact_rels = [
    ...
    "source_v52p/frozen_query_rows.csv",
    "source_v52p/frozen_source_span_rows.csv",
    "source_v52p/source_manifest_rows.csv",
    ...
    "source_v52p/d_abstain_rows.csv",
    "source_v52p/d_wrong_answer_guard_rows.csv",
    "source_v52p/d_resource_rows.csv",
    "source_v52p/ollama_generation_transcript_rows.csv",
    "source_v52p/d_system_metric_rows.csv",
    "source_v52p/V52P_30B_OPEN_WEIGHT_LLM_RAG_V53E_BOUNDARY.md",
    "source_v52p/v52p_30b_open_weight_llm_rag_v53e_1000_manifest.json",
    "source_v52p/sha256_manifest.csv",
    "source_v52q/v52q_70b_open_weight_llm_rag_v53e_1000_summary.csv",
    "source_v52q/frozen_query_rows.csv",
    "source_v52q/frozen_source_span_rows.csv",
    "source_v52q/source_manifest_rows.csv",
    ...
    "source_v52q/e_abstain_rows.csv",
    "source_v52q/e_wrong_answer_guard_rows.csv",
    "source_v52q/e_resource_rows.csv",
    "source_v52q/ollama_generation_transcript_rows.csv",
    "source_v52q/e_system_metric_rows.csv",
    "source_v52q/V52Q_70B_OPEN_WEIGHT_LLM_RAG_V53E_BOUNDARY.md",
    "source_v52q/v52q_70b_open_weight_llm_rag_v53e_1000_manifest.json",
    "source_v52q/sha256_manifest.csv",
