...
receipt_builder.write_text(
    "\n".join([
        ...
        "        errors.append(f'nonfinal-content-witness:{witness_id}')",
        "        continue",
...
minimal_slice_precheck.write_text(
    "\n".join([
        ...
        "        text = path.read_text(encoding='utf-8', errors='replace')",
        "        if has_nonfinal_text(text):",
        "            add(f'witness:{filename}', 'blocked', f'nonfinal-content-witness:{filename}')",
        "            continue",
...
minimal_slice_builder.write_text(
    "\n".join([
        ...
        "    text = path.read_text(encoding='utf-8', errors='replace')",
        "    if has_nonfinal_text(text):",
        "        raise SystemExit(f'nonfinal-content-witness:{filename}')",
...
materializer.write_text(
    "\n".join([
        ...
        "    text = path.read_text(encoding='utf-8', errors='replace')",
        "    if has_nonfinal_text(text):",
        "        raise SystemExit(f'nonfinal-content-witness:{path_key}')",
