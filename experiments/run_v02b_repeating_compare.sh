...
CONTROL_CSV="$RESULTS_DIR/v02b_text_off_pc30.csv"
COUPLED_CSV="$RESULTS_DIR/v02b_text_lv0_lb010_eb002_pc30.csv"

echo "repeating-text: control (pc30, coupling off)"
"$ROOT_DIR/build/dmv02" "${COMMON_ARGS[@]}" --lambda-b 0 --eta-b 0 --csv "$CONTROL_CSV"

echo "repeating-text: weak coupling (pc30, lambda_b=0.1, eta_b=0.02)"
